        ...
        cards = [
            {
                ...
                "rows": [
                    ...
                    {"label": "worker_last_runner_progress_at", "value": None if worker_handle is None else task_shared._isoformat_or_none(worker_handle.last_runner_progress_at)},
                    {"label": "worker_last_sync_maintenance_progress_at", "value": None if worker_handle is None else task_shared._isoformat_or_none(worker_handle.last_sync_maintenance_progress_at)},
