...
class TaskReadModelServiceStructureTests(unittest.TestCase):
    def test_task_manager_read_model_methods_are_bound_to_mixin(self):
        ...
        self.assertIs(TaskManager._runtime_health_group_definition, TaskReadModelServiceMixin._runtime_health_group_definition)
        self.assertIs(TaskManager._runtime_health_group_status, TaskReadModelServiceMixin._runtime_health_group_status)
        self.assertIs(TaskManager._build_runtime_health_groups, TaskReadModelServiceMixin._build_runtime_health_groups)
        self.assertIs(TaskManager._build_runtime_health_spotlight, TaskReadModelServiceMixin._build_runtime_health_spotlight)
        self.assertIs(TaskManager._runtime_health_snapshot_status, TaskReadModelServiceMixin._runtime_health_snapshot_status)
        self.assertIs(TaskManager._build_runtime_health_snapshot_cards, TaskReadModelServiceMixin._build_runtime_health_snapshot_cards)
        self.assertIs(TaskManager._runtime_health_loop_snapshot_label, TaskReadModelServiceMixin._runtime_health_loop_snapshot_label)
        self.assertIs(TaskManager._runtime_health_loop_snapshot_status, TaskReadModelServiceMixin._runtime_health_loop_snapshot_status)
        self.assertIs(TaskManager._build_runtime_health_related_loops, TaskReadModelServiceMixin._build_runtime_health_related_loops)
