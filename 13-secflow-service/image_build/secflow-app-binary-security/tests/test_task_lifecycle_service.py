...
class TaskLifecycleServiceStructureTests(unittest.TestCase):
    def test_task_manager_lifecycle_methods_are_bound_to_lifecycle_mixin(self):
        self.assertIs(TaskManager._operation_lease_ttl_seconds, TaskLifecycleServiceMixin._operation_lease_ttl_seconds)
        self.assertIs(TaskManager._operation_heartbeat_interval_seconds, TaskLifecycleServiceMixin._operation_heartbeat_interval_seconds)
        self.assertIs(TaskManager._stale_operation_requeue_interval_seconds, TaskLifecycleServiceMixin._stale_operation_requeue_interval_seconds)
        ...
        self.assertIs(TaskManager._maybe_requeue_stale_operations, TaskLifecycleServiceMixin._maybe_requeue_stale_operations)
        ...
        self.assertIs(TaskManager._operation_dispatch_loop, TaskLifecycleServiceMixin._operation_dispatch_loop)
