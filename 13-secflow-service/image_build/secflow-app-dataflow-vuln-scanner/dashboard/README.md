...
- 概览页：分数趋势、当前 issues、结果生命周期 manifest、coverage ledger 状态、评审轮次时间线。
...
- 文件浏览：聚合展示 config、input、summary、previous_limitations、supporting_docs、removed_results、manifest/ledger、checkpoints、review、results、sessions 等中间文件。
