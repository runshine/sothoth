...
class TaskResponse(BaseModel):
    ...
    evolution_job_id: Optional[str] = None
    evolution_started_at: Optional[str] = None
    evolution_completed_at: Optional[str] = None
    evolution_target_node: Optional[str] = None
    evolution_source_run_id: Optional[str] = None
    tuned_agent_path: Optional[str] = None
    tuned_agent_status: Optional[str] = None
    tuned_agent_version: Optional[str] = None
