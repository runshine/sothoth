...
1. Read `$output/summary.md` to understand what the unpacker found and what tools it used.
   - If `$output/summary.md` does not exist, stop the review and report failure.
   - If `$output` is empty or contains no extraction artifact other than `summary.md` and `reason.md`, stop the review and report failure.
