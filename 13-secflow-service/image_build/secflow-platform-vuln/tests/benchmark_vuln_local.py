            ...
            create_result = await _benchmark_requests(
                ...
                request_factory=lambda index: client.post(
                    ...
                    json={
                        ...
                        "report_id": f"bench-report-{index}",
                        ...
                        "state": "suspected",
                        "category": "bench_case",
                        "reporter": {"name": "bench", "version": "1.0.0", "type": "human"},
                        "subject": {"type": "http_endpoint", "locator": f"/bench/{index}"},
                        "evidence": {"summary": "benchmark", "references": []},
                        "artifacts": [],
                        "metadata": {"source": {"source_service": "bench"}},
                    },
                ),
            )
            ...
            for index in range(15):
                create_resp = await client.post(
                    ...
                    json={
                        ...
                        "category": "bench_flow",
                        "reporter": {"name": "bench", "version": "1.0.0", "type": "human"},
                        "subject": {"type": "service", "locator": f"svc://flow/{index}"},
                        "evidence": {"summary": "stateful-flow", "references": []},
                        "artifacts": [],
                        "metadata": {"source": {"source_service": "bench"}},
                    },
                )
