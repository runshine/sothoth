...
if [ "$ARCH" = "aarch64" ];then
  ...
  URL="https://github.com/astral-sh/python-build-standalone/releases/download/20250818/cpython-3.12.11+20250818-armv7-unknown-linux-gnueabi-install_only.tar.gz"
fi
